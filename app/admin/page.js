...
function AdminCommandCenter() {
    ...
    const triggerForceSync = useCallback(async (type) => {
            ...
            <div className="flex flex-col items-center justify-center min-h-screen px-4 bg-[#050510]">
                ...
                >
                    ...
                    <div className="flex flex-col items-center text-center">
                        <div className="w-24 h-24 bg-blue-500/10 rounded-3xl flex items-center justify-center mb-8 rotate-12 transition-transform duration-500">
                        ...
                        <div className="w-full space-y-6">
                            <div className="space-y-2 text-left">
                                ...
                                <input
                                    ...
                                    className="w-full bg-white/[0.03] border border-white/5 rounded-2xl px-6 py-5 outline-none focus:border-cyan-500/50 focus:bg-white/5 transition-all font-mono text-center text-xl tracking-[0.3em] text-white"
                                        ...
                                        <table className="w-full text-left border-collapse">
                                            ...
                                            <tbody className="divide-y divide-white/[0.02]">
                                                {stats?.api_health && stats.api_health.length > 0 ? (
                                                    ...
                                                    <tr><td colSpan="4" className="px-10 py-32 text-center text-white/10 italic font-medium uppercase tracking-[0.3em] text-sm group">正在等待巡检心跳信号</td></tr>
                                                )}
                                            </tbody>
                                        </table>
                                    </div>
